document.addEventListener('DOMContentLoaded', function () {
  var CURRENT_PORT = (window.location.port || '5000');
  var PORTS = { admin: CURRENT_PORT, app: CURRENT_PORT };
  ...
  function buildAbsolute(path, port) {
    var origin = window.location.protocol + '//' + HOST + ':' + (port || CURRENT_PORT);
  ...
  if (logo) {
    var home = buildAbsolute('FAST%20V2.html', PORTS.app);
